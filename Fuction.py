...
print(7, "의 8진수 : " , bin(7))
print(8, "의 8진수 : " , bin(8))
print(15, "의 16진수 : " , bin(15))
print(16, "의 16진수 : " , bin(16))
...
strings = ["정유경", "블랙핑", "율무", "박성래"]
print(strings, "중 가장 큰 값은", max(strings))
print(strings, "중 가장 작은 값은", min(strings))
#print(strings, "합계는", sum(strings))
#print("정유경의 10승은", pow("정유경", 10))
...
# user_name = input("이름은")
# user_age = input("나이는")
# print(user_name + "님 나이는 " + str(user_age) + "세군요!") #str 빼면 에러남
...
# print(say.format(name = user_name, user_age))
